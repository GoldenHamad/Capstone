...
def get_url(imagePath):
    cloudinary.config(
    cloud_name = 'place your cloudinary cloud name here',
    api_key = 'place your cloudinary api key here',
    api_secret = 'place your cloudinary api secret here'
    )
...
def get_predict(descriptions: AccidentDescription, img_url):
    api_key = "place your api key here"
    # Configuration
    Assistant_ID = "place your assistant id here"
